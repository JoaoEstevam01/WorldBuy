...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "<script>alert('Muito obrigado pelo contato'); window.location.href = '/site-de-venda/index.php';</script>";
    exit();
}
?>
...
<body class="contact-form">
    <div class="form-container">
        <h2 style="font-family: 'Mulish', sans-serif;">Fale Conosco</h2>
        <form action="fale_conosco.php" method="post">
            ...
            <textarea name="mensagem" placeholder="Mensagem" required style="font-family: 'Mulish', sans-serif;"></textarea>
